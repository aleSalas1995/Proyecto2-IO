...
def iniciarDinamica(minaDeOro,iteraciones):
    ...
    #Inicia el tiempo y los contadores
    ...
    while i < iteraciones:
        ...
        solucion  = solucionDinamica(minaDeOro,filas,columnas)#Llama a la funcion solucionDinamica y le pasa los paramtros
        #print(solucion)
        ...
        i = i + 1
        llenarMatrizCantidad(filas,columnas)#Llama a la funcion de llenarMatrizCantidad y le pasa las filas y columnas respectivas
...
def solucionDinamica(minaDeOro,filas,columnas):
    ...
    #Recorre mediante el while el largo de las filas
    while i < filas:
...
#Recibe el numero de filas y columnas
...
def mainPD( archivo):
    ...
    llenarMatrizCantidad(filas,columnas)#Llena la matriz de 0's en sus campos
    print("La cantidad maxima de oro es: " + str(solucionDinamica(mina,filas,columnas)))#Imprime la solucion
    print("Duracion con programacion dinamica: " + str(time.time() - start_time))#Imprime el tiempo que duro calculandolo
